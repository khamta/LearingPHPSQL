        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <span class="d-flex justify-content-end">
                    <a href="emp_manage.php" class="btn btn-secondary"><i
                            class="fas fa-address-card"></i>&nbsp;ສະແດງຂໍ້ມຸນ</a>
                </span>
                <div class="card">
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="empno"
                                                    placeholder="ປ້ອນລະຫັດພະນັກງານ" name="empno" required
                                                    value="<?= @$empno?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="empname"
                                                    placeholder="ປ້ອນຊື່ພະນັກງານ" name="empname" required
                                                    value="<?= @$empname?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="date_birth"
                                                    name="date_birth" required value="<?= @$date_birth?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <!-- ທີ່ຢູ່ -->
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="5" id="address"
                                                    name="address"><?=strip_tags(@$address)?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div style="text-align: center">
                                                <img id='img-upload' />
                                                <div id="temp_img">
                                                    <img src="image/avatar_img.png" alt="" width="150px"
                                                        height="180px" />
                                                </div>
                                                <!--ເລືອກຮູບພາບ-->
                                                <br>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="department" id="department"
                                                    ...
                                                    <option value="<?= $row['d_ID'] ?>"
                                                        <?php if(@$department == $row['d_ID']) echo 'selected'; ?>>
                                                        <?= $row['name'] ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="salary" id="salary" required="true">
                                            ...
                                            <option value="<?= $row['grade'] ?>"
                                                ...
                                                <?= $row['grade'] . " = " . number_format($row['salary']) ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="incentive" id="incentive"
                                            placeholder="ປ້ອນເງິນອຸດໜູນ" value="<?= @$incentive?>" min="0">
                                    </div>
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="submit" name="btnAdd" class="btn btn-primary"
                                        style="width: 110px; border-radius: 20px;">ເພີ່ມຂໍ້ມູນ</button>
                                    <button type="reset" class="btn btn-warning"
                                        style="width: 110px; border-radius: 20px;">ຍົກເລີກ</button>
                                    <button onclick="window.location.reload(true)" class="btn btn-success"
                                        style="width: 110px; border-radius: 20px;">ໂຫຼດຄືນໃໝ່</button>
                                </div>
                        </form>
                    </div>
